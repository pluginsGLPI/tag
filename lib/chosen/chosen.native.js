// ChosenT, a Select Box Enhancer for JavaScript
// by Patrick Filler for Harvest, http://getharvest.com
//
// Version 0.13.0
// Full source at https://github.com/harvesthq/chosenT
// Copyright (c) 2011 Harvest http://getharvest.com

// MIT License, https://github.com/harvesthq/chosenT/blob/master/LICENSE.md
// This file is generated by `grunt build`, do not edit it by hand.
(function() {
  var AbstractChosenT, DOM, Events, SelectParser, Util, emulated_event_mapped_to, emulated_events, is_emulated_event, temp_el, unwrap_emulated_event, wrap_emulated_event, _ref,
  ...
  wrap_emulated_event = function(el, type, fn) {
    ...
    if (el._chosenT_wrapped == null) {
      el._chosenT_wrapped = {};
    }
    if (el._chosenT_wrapped[wrapped_fn_key] == null) {
      el._chosenT_wrapped[wrapped_fn_key] = emulated_events[type].handler(el, fn);
    }
    return el._chosenT_wrapped[wrapped_fn_key];
  };
  ...
  unwrap_emulated_event = function(el, type, fn) {
    ...
    el._chosenT_wrapped[wrapped_fn_key] = null;
    return wrapped_fn;
  };
      ...
      if (option.nodeName.toUpperCase() === "OPTION") {
        if (option.text !== "") {
          ...
          this.parsed.push({
            ...
            color_option: (option.getAttribute("data-color-option") != '' ? option.getAttribute("data-color-option") : '') // GET VALUE FROM DATA ATTRIBUTE
          });
        } else {
          this.parsed.push({
            array_index: this.parsed.length,
  ...
  AbstractChosenT = (function() {
    function AbstractChosenT(form_field, options) {
      this.form_field = form_field;
      this.options = options != null ? options : {};
      if (!AbstractChosenT.browser_is_supported()) {
        return;
      }
    ...
    AbstractChosenT.prototype.set_default_values = function() {
      var _this = this;
    ...
    AbstractChosenT.prototype.set_default_text = function() {
      if (this.form_field.getAttribute("data-placeholder")) {
        this.default_text = this.form_field.getAttribute("data-placeholder");
      } else if (this.is_multiple) {
        this.default_text = this.options.placeholder_text_multiple || this.options.placeholder_text || AbstractChosenT.default_multiple_text;
      } else {
        this.default_text = this.options.placeholder_text_single || this.options.placeholder_text || AbstractChosenT.default_single_text;
      }
      return this.results_none_found = this.form_field.getAttribute("data-no_results_text") || this.options.no_results_text || AbstractChosenT.default_no_result_text;
    };

    AbstractChosenT.prototype.mouse_enter = function() {
      return this.mouse_on_container = true;
    };

    AbstractChosenT.prototype.mouse_leave = function() {
      return this.mouse_on_container = false;
    };

    AbstractChosenT.prototype.input_focus = function(evt) {
      var _this = this;
      if (this.is_multiple) {
    ...
    AbstractChosenT.prototype.input_blur = function(evt) {
      var _this = this;
    ...
    AbstractChosenT.prototype.results_option_build = function(options) {
    ...
    AbstractChosenT.prototype.result_add_option = function(option) {
      var classes, style;
      classes = [];
      ...
      return "<li class=\"" + (classes.join(' ')) + "\"" + style + " data-option-array-index=\"" + option.array_index + "\" data-color-option=\"" + option.color_option + "\">" + option.search_text + "</li>";
    };

    AbstractChosenT.prototype.result_add_group = function(group) {
      return "<li class=\"group-result\">" + group.search_text + "</li>";
    };

    AbstractChosenT.prototype.results_update_field = function() {
      this.set_default_text();
      if (!this.is_multiple) {
    ...
    AbstractChosenT.prototype.results_toggle = function() {
      if (this.results_showing) {
    ...
    AbstractChosenT.prototype.results_search = function(evt) {
      if (this.results_showing) {
        return this.winnow_results();
      } else {
        return this.results_show();
    ...
    AbstractChosenT.prototype.winnow_results = function() {
    ...
    AbstractChosenT.prototype.search_string_match = function(search_string, regex) {
    ...
    AbstractChosenT.prototype.choices_count = function() {
    ...
    AbstractChosenT.prototype.choices_click = function(evt) {
      evt.preventDefault();
    ...
    AbstractChosenT.prototype.keyup_checker = function(evt) {
      var stroke, _ref;
    ...
    AbstractChosenT.prototype.container_width = function() {
    ...
    AbstractChosenT.browser_is_supported = function() {
      var _ref;
    ...
    AbstractChosenT.default_multiple_text = "Select Some Options";

    AbstractChosenT.default_single_text = "Select an Option";

    AbstractChosenT.default_no_result_text = "No results match";

    return AbstractChosenT;

  })();

  this.ChosenT = (function(_super) {
    __extends(ChosenT, _super);

    function ChosenT() {
      _ref = ChosenT.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    ChosenT.prototype.setup = function() {
      this.current_selectedIndex = this.form_field.selectedIndex;
      return this.is_rtl = DOM.has_class(this.form_field, "chzn-rtl");
    };

    ChosenT.prototype.finish_setup = function() {
      return DOM.add_class(this.form_field, "chzn-done");
    };

    ChosenT.prototype.set_up_html = function() {
      var container_classes, container_props, key, value;
      container_classes = ["chznT-container"];
      container_classes.push("chznT-container-" + (this.is_multiple ? "multi" : "single"));
    ...
    ChosenT.prototype.register_observers = function() {
      var _this = this;
    ...
    ChosenT.prototype.search_field_disabled = function() {
    ...
    ChosenT.prototype.container_mousedown = function(evt) {
      if (!this.is_disabled) {
    ...
    ChosenT.prototype.container_mouseup = function(evt) {
      if (evt.target.nodeName === "ABBR" && !this.is_disabled) {
        return this.results_reset(evt);
      }
    };

    ChosenT.prototype.search_results_mousewheel = function(evt) {
    ...
    ChosenT.prototype.blur_test = function(evt) {
      if (!this.active_field && DOM.has_class(this.container, "chznT-container-active")) {
        return this.close_field();
      }
    };

    ChosenT.prototype.close_field = function() {
      Events.remove(document, "click", this.click_test_action);
      this.active_field = false;
      this.results_hide();
      DOM.remove_class(this.container, "chznT-container-active");
      this.clear_backstroke();
      this.show_search_field_default();
      return this.search_field_scale();
    };

    ChosenT.prototype.activate_field = function() {
      DOM.add_class(this.container, "chznT-container-active");
      this.active_field = true;
      this.search_field.value = this.search_field.value;
      return this.search_field.focus();
    };

    ChosenT.prototype.test_active_click = function(evt) {
      var selected_container;
      selected_container = DOM.find_parent(evt.target.parentNode, function(el) {
        return DOM.has_class(el, 'chznT-container');
      });
    ...
    ChosenT.prototype.results_build = function() {
      ...
      if (this.is_multiple) {
        ...
        if (this.disable_search || this.form_field.options.length <= this.disable_search_threshold) {
          ...
          DOM.add_class(this.container, "chznT-container-single-nosearch");
        } else {
          this.search_field.readOnly = false;
          DOM.remove_class(this.container, "chznT-container-single-nosearch");
        }
      }
      this.update_results_content(this.results_option_build({
        first: true
    ...
    ChosenT.prototype.result_do_highlight = function(el) {
    ...
    ChosenT.prototype.result_clear_highlight = function() {
    ...
    ChosenT.prototype.results_show = function() {
    ...
    ChosenT.prototype.update_results_content = function(content) {
      return this.search_results.innerHTML = content;
    };

    ChosenT.prototype.results_hide = function() {
      if (this.results_showing) {
        this.result_clear_highlight();
    ...
    ChosenT.prototype.set_tab_index = function(el) {
      var ti;
    ...
    ChosenT.prototype.set_label_behavior = function() {
      var _this = this;
    ...
    ChosenT.prototype.show_search_field_default = function() {
    ...
    ChosenT.prototype.search_results_mouseup = function(evt) {
      var target;
    ...
    ChosenT.prototype.search_results_mouseover = function(evt) {
      var target;
      target = DOM.has_class(evt.target, "active-result") ? evt.target : DOM.find_parent(evt.target, function(el) {
        return DOM.has_class(el, "active-result");
      });
    ...
    ChosenT.prototype.search_results_mouseout = function(evt) {
    ...
    ChosenT.prototype.choice_build = function(item) {
      var choice, close_link,
        _this = this;
      choice = document.createElement('li');
      choice.className = "search-choice";
      choice.style.borderColor = item.color_option;
    ...
    ChosenT.prototype.choice_destroy_link_click = function(evt) {
      evt.preventDefault();
      evt.stopPropagation();
      if (!this.is_disabled) {
    ...
    ChosenT.prototype.choice_destroy = function(link) {
      var li;
    ...
    ChosenT.prototype.results_reset = function() {
    ...
    ChosenT.prototype.results_reset_cleanup = function() {
      var abbr;
      this.current_selectedIndex = this.form_field.selectedIndex;
    ...
    ChosenT.prototype.result_select = function(evt) {
    ...
    ChosenT.prototype.single_set_selected_text = function(text) {
      if (text == null) {
    ...
    ChosenT.prototype.result_deselect = function(pos) {
      var result_data;
    ...
    ChosenT.prototype.single_deselect_control_build = function() {
      var abbr, span;
    ...
    ChosenT.prototype.get_search_text = function() {
    ...
    ChosenT.prototype.winnow_results_set_highlight = function() {
    ...
    ChosenT.prototype.no_results = function(terms) {
      var li, span;
    ...
    ChosenT.prototype.no_results_clear = function() {
      var no_results;
    ...
    ChosenT.prototype.keydown_arrow = function() {
      var next_sib,
        _this = this;
    ...
    ChosenT.prototype.keyup_arrow = function() {
      var prev_sib,
        _this = this;
    ...
    ChosenT.prototype.keydown_backstroke = function() {
    ...
    ChosenT.prototype.clear_backstroke = function() {
      if (this.pending_backstroke) {
    ...
    ChosenT.prototype.keydown_checker = function(evt) {
      var stroke, _ref1;
    ...
    ChosenT.prototype.search_field_scale = function() {
